...
import {
    ...
    Heart, Filter, Award, Utensils, Camera, Navigation
} from 'lucide-react';

import { productService, categoryService, roomService } from '../../api';
...
const HotelLandingPage = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const availableRooms = (rooms.data || rooms).filter(room =>
                    !room.reserved && room.is_active);
                const products = await productService.getProducts();
                const categories = await categoryService.getCategories();
                setFeaturedRooms(availableRooms); setFeaturedProducts(products.data || products); setCategoryChoices(categories.data || categories);
    ...
    const heroSlides = [
        {
            ...
            image: "bg-gradient-to-r from-amber-600 to-orange-500"
        },
        {
        ...
        },
        {
            ...
            image: "bg-gradient-to-r from-green-600 to-teal-600"
        }
    ];
    ...
    const addToCart = (product, quantity = 1) => {
        ...
        if (existingItem) {
            ...
            const newCart = {
                items: updatedItems,
                total_amount: updatedItems.reduce((sum, item) => sum + (item.quantity * item.product.price), 0),
                    ...
                    <div className="max-w-4xl mx-auto px-4">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            <button
                                ...
                                className="bg-amber-600 text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-amber-700 transition-colors transform hover:scale-105"
                            >
                                Book Your Stay
                            </button>
                            <button
            ...
            <section className="py-12 bg-gray-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="bg-white rounded-2xl shadow-lg p-8">
                        <h2 className="text-2xl font-bold text-gray-900 mb-6 text-center">Quick Booking</h2>
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                            ...
                            <div className="flex items-end">
                                <button className="w-full bg-amber-600 text-white px-6 py-2 rounded-md hover:bg-amber-700 transition-colors font-semibold">
                                    Search Rooms
                                </button>
                            </div>
                        </div>
                                ...
                                <div key={room.id} className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300 group">
                                    ...
                                    <div className="p-6">
                                        ...
                                        <div className="flex space-x-2">
                                            ...
                                            <button className="flex-1 inline-flex items-center justify-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-amber-600 hover:bg-amber-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-500 transition-colors">
                                                Book Now
                                            </button>
                                        </div>
                                    </div>
            ...
            <section id="services" className="py-16 bg-gray-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                            Enhance your stay with our carefully curated selection of services and products
                        </p>
                    </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-gray-300">info@grandhotel.com</p>
                            <p className="text-gray-300">reservations@grandhotel.com</p>
                        </div>
                        <div className="text-center">
                            <div className="w-16 h-16 bg-amber-600 rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                        <div>
                            ...
                            <p className="text-gray-300 mb-4">Experience luxury and comfort in the heart of the city with our premium accommodations and exceptional service.</p>
                        </div>
                        <div>
                                            ...
                                            <div key={item.id} className="flex items-center space-x-4 p-4 border border-gray-200 rounded-lg">
                                                <div className="flex-shrink-0 w-16 h-16 bg-gray-100 rounded-lg flex items-center justify-center">
                                                    <img
                                                        ...
                                                        src={getImageUrl(item.product.image.replace(/^https?:\/\/[^/]+/, ''))}
                    ...
                    <div className="relative bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
                        <div className="bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between rounded-t-lg">
                            <h3 className="text-xl font-semibold text-gray-900">
                                Room {selectedRoom.room_code} Details
                            </h3>
                            <button
                        ...
                        <div className="p-6">
                            <div className={`mb-6 p-6 bg-gradient-to-r ${getCategoryConfig(selectedRoom.categories).gradient} rounded-lg`}>
                                <div className="flex items-center justify-between">
                                    <div>
                                        <h4 className="text-2xl font-bold text-gray-900 mb-2">
                                            Room {selectedRoom.room_code}
                                        </h4>
                                        <p className="text-gray-600">{getCategoryConfig(selectedRoom.categories).label} Category</p>
                        ...
                        <div className="bg-gray-50 border-t border-gray-200 px-6 py-4 rounded-b-lg">
                            <div className="flex justify-end space-x-3">
                                ...
                                <button className="px-6 py-2 text-sm font-medium text-white bg-amber-600 border border-transparent rounded-md hover:bg-amber-700">
                                    Book This Room
                                </button>
                            </div>
                        </div>
                        ...
                        <div className="bg-gray-50 border-t border-gray-200 px-6 py-4 rounded-b-lg">
                            <div className="flex justify-end space-x-3">
                                ...
                                <button
                                    ...
                                    className="px-6 py-2 text-sm font-medium text-white bg-amber-600 border border-transparent rounded-md hover:bg-amber-700"
                                >
                                    Add to Cart
                                </button>
                            </div>
